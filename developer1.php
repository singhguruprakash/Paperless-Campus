...
if(empty($_REQUEST['m_pass']))
	...
	$m_type=$_REQUEST['m_type'];
		$query="insert into management(m_id,m_name,m_mobile,m_type,m_pass)Values(NULL,'".$m_name."','".$m_mobile."','".$m_type."','".$m_pass."') ";
		if($conn->query($query))
		{
...
<div class="signup-form">
    <form action="#" method="POST">
        ...
        <div class="form-group">
        	<input type="number" class="form-control" name="m_mobile" placeholder="Mobile Number *" required>
        </div>
        <div class="form-group">
        	<select name="m_type">
        ...
        <div class="form-group">
        	<input type="password" class="form-control" name="m_pass" placeholder="Password *" required>
        </div>
		<div class="form-group">
