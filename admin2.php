<?php
 ...
 if(isset($_REQUEST['login']))
 {
	...
	$query = "select * from management where m_mobile='".$fmo."' and m_pass='".$fpass."'";
...
<form class="form-group p-3" method="post" ">
 ...
 <h3  class="text-center font-weight-bold text-warning " style="padding-top:30px;"> <b>Log In(Management) </b></h3> <br><br>
